 ...
 * This is the modified Graph implementation code to test  
 * the use of an adjacency matrix
 * 
 * Original: Graph represents an adjacency matrix implementation of a graph.
...
public class Graph<T> implements GraphADT<T>
{
     ...
     * @return the index value of the given vertex (-1 if not found)
     */
